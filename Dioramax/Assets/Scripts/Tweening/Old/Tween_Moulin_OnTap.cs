...
public class Tween_Moulin_OnTap : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        //rotation
        LeanTween.rotateAround(gameObject, Vector3.right, rotation_degrees, time_rotation).setEasePunch().setLoopCount(-1);
